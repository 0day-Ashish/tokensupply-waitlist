...
const GradientWaves: React.FC<GradientWavesProps> = ({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      vertex,
      fragment,
      // The shader outputs premultiplied alpha; without transparent:true ogl
      // leaves GL_BLEND off and the whole canvas renders empty.
      transparent: true,
      depthTest: false,
      uniforms: {
        iTime: { value: 0 },
    ...
    // Match the shader's premultiplied output (ogl's default assumes straight alpha).
